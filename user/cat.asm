...
cat(int fd)
{
  ...
  24:	2f4080e7          	jalr	756(ra) # 314 <read>
  28:	84aa                	mv	s1,a0
  2a:	02a05763          	blez	a0,58 <cat+0x58>
    if (write(1, buf, n) != n) {
  2e:	8626                	mv	a2,s1
  30:	85ca                	mv	a1,s2
  32:	4505                	li	a0,1
  34:	00000097          	auipc	ra,0x0
  38:	2e8080e7          	jalr	744(ra) # 31c <write>
  3c:	fc950ee3          	beq	a0,s1,18 <cat+0x18>
      printf("cat: write error\n");
  40:	00000517          	auipc	a0,0x0
  44:	7f850513          	addi	a0,a0,2040 # 838 <malloc+0xe6>
  48:	00000097          	auipc	ra,0x0
  4c:	64c080e7          	jalr	1612(ra) # 694 <printf>
      exit();
  ...
  if(n < 0){
  58:	00054963          	bltz	a0,6a <cat+0x6a>
  ...
  6e:	7e650513          	addi	a0,a0,2022 # 850 <malloc+0xfe>
  72:	00000097          	auipc	ra,0x0
  76:	622080e7          	jalr	1570(ra) # 694 <printf>
    exit();
  7a:	00000097          	auipc	ra,0x0
  7e:	282080e7          	jalr	642(ra) # 2fc <exit>
...
main(int argc, char *argv[])
{
  ...
  if(argc <= 1){
  92:	4785                	li	a5,1
  94:	04a7d663          	bge	a5,a0,e0 <main+0x5e>
  98:	00858913          	addi	s2,a1,8
  9c:	ffe5099b          	addiw	s3,a0,-2
  a0:	02099793          	slli	a5,s3,0x20
  a4:	01d7d993          	srli	s3,a5,0x1d
  a8:	05c1                	addi	a1,a1,16
  aa:	99ae                	add	s3,s3,a1
    cat(0);
    exit();
  }
  ...
  ac:	4581                	li	a1,0
  ae:	00093503          	ld	a0,0(s2)
  b2:	00000097          	auipc	ra,0x0
  b6:	28a080e7          	jalr	650(ra) # 33c <open>
  ba:	84aa                	mv	s1,a0
  bc:	02054b63          	bltz	a0,f2 <main+0x70>
      printf("cat: cannot open %s\n", argv[i]);
      exit();
    }
    cat(fd);
  c0:	00000097          	auipc	ra,0x0
  c4:	f40080e7          	jalr	-192(ra) # 0 <cat>
    close(fd);
  c8:	8526                	mv	a0,s1
  ca:	00000097          	auipc	ra,0x0
  ce:	25a080e7          	jalr	602(ra) # 324 <close>
  for(i = 1; i < argc; i++){
  d2:	0921                	addi	s2,s2,8
  d4:	fd391ce3          	bne	s2,s3,ac <main+0x2a>
  }
  exit();
  d8:	00000097          	auipc	ra,0x0
  dc:	224080e7          	jalr	548(ra) # 2fc <exit>
    cat(0);
  e0:	4501                	li	a0,0
  e2:	00000097          	auipc	ra,0x0
  e6:	f1e080e7          	jalr	-226(ra) # 0 <cat>
    exit();
  ea:	00000097          	auipc	ra,0x0
  ee:	212080e7          	jalr	530(ra) # 2fc <exit>
      printf("cat: cannot open %s\n", argv[i]);
  f2:	00093583          	ld	a1,0(s2)
  f6:	00000517          	auipc	a0,0x0
  fa:	77250513          	addi	a0,a0,1906 # 868 <malloc+0x116>
  fe:	00000097          	auipc	ra,0x0
 102:	596080e7          	jalr	1430(ra) # 694 <printf>
      exit();
 106:	00000097          	auipc	ra,0x0
 10a:	1f6080e7          	jalr	502(ra) # 2fc <exit>
...
gets(char *buf, int max)
{
 ...
 1fc:	11c080e7          	jalr	284(ra) # 314 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 24e:	0f2080e7          	jalr	242(ra) # 33c <open>
  if(fd < 0)
 ...
 25e:	0fa080e7          	jalr	250(ra) # 354 <fstat>
 262:	892a                	mv	s2,a0
  close(fd);
 264:	8526                	mv	a0,s1
 266:	00000097          	auipc	ra,0x0
 26a:	0be080e7          	jalr	190(ra) # 324 <close>
  return r;
}
 26e:	854a                	mv	a0,s2
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 2ce:	0800                	addi	s0,sp,16
  ...
  src = vsrc;
  while(n-- > 0)
 2d0:	00c05f63          	blez	a2,2ee <memmove+0x24>
 ...
 2e6:	fee78fa3          	sb	a4,-1(a5)
  while(n-- > 0)
 2ea:	fed79ae3          	bne	a5,a3,2de <memmove+0x14>
  return vdst;
}
 2ee:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 404:	48850513          	addi	a0,a0,1160 # 888 <digits>
 408:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d0:	3bcb8b93          	addi	s7,s7,956 # 888 <digits>
 ...
 610:	27490913          	addi	s2,s2,628 # 880 <malloc+0x12e>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d8:	1cc7b783          	ld	a5,460(a5) # 8a0 <freep>
 ...
 706:	00e6ea63          	bltu	a3,a4,71a <free+0x50>
{
 ...
 748:	14f73e23          	sd	a5,348(a4) # 8a0 <freep>
}
 74c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 77a:	12a53503          	ld	a0,298(a0) # 8a0 <freep>
 ...
 7a2:	10290913          	addi	s2,s2,258 # 8a0 <freep>
  if(p == (char*)-1)
 7a6:	5afd                	li	s5,-1
 7a8:	a895                	j	81c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7aa:	00000797          	auipc	a5,0x0
 7ae:	2fe78793          	addi	a5,a5,766 # aa8 <base>
 7b2:	00000717          	auipc	a4,0x0
 7b6:	0ef73723          	sd	a5,238(a4) # 8a0 <freep>
 7ba:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 82c:	b5c080e7          	jalr	-1188(ra) # 384 <sbrk>
  if(p == (char*)-1)
