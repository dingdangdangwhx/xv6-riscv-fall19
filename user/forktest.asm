...
print(const char *s)
{
  ...
  10:	14e080e7          	jalr	334(ra) # 15a <strlen>
  14:	0005061b          	sext.w	a2,a0
  18:	85a6                	mv	a1,s1
  1a:	4505                	li	a0,1
  1c:	00000097          	auipc	ra,0x0
  20:	304080e7          	jalr	772(ra) # 320 <write>
}
  24:	60e2                	ld	ra,24(sp)
  26:	6442                	ld	s0,16(sp)
  28:	64a2                	ld	s1,8(sp)
...
forktest(void)
{
  ...
  3e:	38650513          	addi	a0,a0,902 # 3c0 <umount+0x8>
  ...
  54:	2a8080e7          	jalr	680(ra) # 2f8 <fork>
    if(pid < 0)
  58:	02054663          	bltz	a0,84 <forktest+0x56>
      break;
    if(pid == 0)
  5c:	c105                	beqz	a0,7c <forktest+0x4e>
  for(n=0; n<N; n++){
  ...
  68:	36c50513          	addi	a0,a0,876 # 3d0 <umount+0x18>
  ...
  80:	284080e7          	jalr	644(ra) # 300 <exit>
  if(n == N){
  84:	3e800793          	li	a5,1000
  88:	fcf48ee3          	beq	s1,a5,64 <forktest+0x36>
  }

  for(; n > 0; n--){
  8c:	00905a63          	blez	s1,a0 <forktest+0x72>
    if(wait() < 0){
  90:	00000097          	auipc	ra,0x0
  94:	278080e7          	jalr	632(ra) # 308 <wait>
  98:	02054963          	bltz	a0,ca <forktest+0x9c>
  for(; n > 0; n--){
  9c:	34fd                	addiw	s1,s1,-1
  9e:	f8ed                	bnez	s1,90 <forktest+0x62>
  ...
  a4:	268080e7          	jalr	616(ra) # 308 <wait>
  a8:	57fd                	li	a5,-1
  aa:	02f51c63          	bne	a0,a5,e2 <forktest+0xb4>
  ...
  b2:	37250513          	addi	a0,a0,882 # 420 <umount+0x68>
  ...
  ce:	32650513          	addi	a0,a0,806 # 3f0 <umount+0x38>
  d2:	00000097          	auipc	ra,0x0
  d6:	f2e080e7          	jalr	-210(ra) # 0 <print>
      exit();
  da:	00000097          	auipc	ra,0x0
  de:	226080e7          	jalr	550(ra) # 300 <exit>
    print("wait got too many\n");
  e2:	00000517          	auipc	a0,0x0
  e6:	32650513          	addi	a0,a0,806 # 408 <umount+0x50>
  ea:	00000097          	auipc	ra,0x0
  ee:	f16080e7          	jalr	-234(ra) # 0 <print>
    exit();
  f2:	00000097          	auipc	ra,0x0
  f6:	20e080e7          	jalr	526(ra) # 300 <exit>
...
main(void)
{
 ...
 106:	f2c080e7          	jalr	-212(ra) # 2e <forktest>
  exit();
 10a:	00000097          	auipc	ra,0x0
 10e:	1f6080e7          	jalr	502(ra) # 300 <exit>
...
gets(char *buf, int max)
{
 ...
 200:	11c080e7          	jalr	284(ra) # 318 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 252:	0f2080e7          	jalr	242(ra) # 340 <open>
  if(fd < 0)
 ...
 262:	0fa080e7          	jalr	250(ra) # 358 <fstat>
 266:	892a                	mv	s2,a0
  close(fd);
 268:	8526                	mv	a0,s1
 26a:	00000097          	auipc	ra,0x0
 26e:	0be080e7          	jalr	190(ra) # 328 <close>
  return r;
}
 272:	854a                	mv	a0,s2
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 2d2:	0800                	addi	s0,sp,16
  ...
  src = vsrc;
  while(n-- > 0)
 2d4:	00c05f63          	blez	a2,2f2 <memmove+0x24>
 2d8:	1602                	slli	a2,a2,0x20
 2da:	9201                	srli	a2,a2,0x20
 2dc:	00c506b3          	add	a3,a0,a2
  dst = vdst;
 2e0:	87aa                	mv	a5,a0
    *dst++ = *src++;
 ...
 2ea:	fee78fa3          	sb	a4,-1(a5)
  while(n-- > 0)
 2ee:	fed79ae3          	bne	a5,a3,2e2 <memmove+0x14>
  return vdst;
}
 2f2:	6422                	ld	s0,8(sp)
