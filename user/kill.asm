...
main(int argc, char **argv)
{
  ...
  2c:	1aa080e7          	jalr	426(ra) # 1d2 <atoi>
  30:	00000097          	auipc	ra,0x0
  34:	24e080e7          	jalr	590(ra) # 27e <kill>
  for(i=1; i<argc; i++)
  38:	04a1                	addi	s1,s1,8
  3a:	ff2496e3          	bne	s1,s2,26 <main+0x26>
  exit();
  3e:	00000097          	auipc	ra,0x0
  42:	210080e7          	jalr	528(ra) # 24e <exit>
    fprintf(2, "usage: kill pid...\n");
  46:	00000597          	auipc	a1,0x0
  4a:	74a58593          	addi	a1,a1,1866 # 790 <malloc+0xec>
  4e:	4509                	li	a0,2
  50:	00000097          	auipc	ra,0x0
  54:	568080e7          	jalr	1384(ra) # 5b8 <fprintf>
    exit();
  58:	00000097          	auipc	ra,0x0
  5c:	1f6080e7          	jalr	502(ra) # 24e <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 356:	45e50513          	addi	a0,a0,1118 # 7b0 <digits>
 35a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 422:	392b8b93          	addi	s7,s7,914 # 7b0 <digits>
 ...
 562:	24a90913          	addi	s2,s2,586 # 7a8 <malloc+0x104>
        while(*s != 0){
...
free(void *ap)
{
 ...
 62a:	1a27b783          	ld	a5,418(a5) # 7c8 <freep>
 ...
 658:	00e6ea63          	bltu	a3,a4,66c <free+0x50>
{
 ...
 69a:	12f73923          	sd	a5,306(a4) # 7c8 <freep>
}
 69e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6cc:	10053503          	ld	a0,256(a0) # 7c8 <freep>
 ...
 6f4:	0d890913          	addi	s2,s2,216 # 7c8 <freep>
  if(p == (char*)-1)
 6f8:	5afd                	li	s5,-1
 6fa:	a895                	j	76e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 6fc:	00000797          	auipc	a5,0x0
 700:	0d478793          	addi	a5,a5,212 # 7d0 <base>
 704:	00000717          	auipc	a4,0x0
 708:	0cf73223          	sd	a5,196(a4) # 7c8 <freep>
 70c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 730:	08a73e23          	sd	a0,156(a4) # 7c8 <freep>
      return (void*)(p + 1);
