...
kinit()
{
  ...
  bd_init(p, (void*)PHYSTOP);
    ...
    80000870:	450080e7          	jalr	1104(ra) # 80006cbc <bd_init>
}
...
kfree(void *pa)
{
  ...
  bd_free(pa);
    ...
    80000888:	f5a080e7          	jalr	-166(ra) # 800067de <bd_free>
}
...
kalloc(void)
{
  ...
  return bd_malloc(PGSIZE);
    ...
    800008a2:	d54080e7          	jalr	-684(ra) # 800065f2 <bd_malloc>
}
...
filealloc(void)
{
  ...
  f=bd_malloc(sizeof(struct file));
    ...
    80004384:	272080e7          	jalr	626(ra) # 800065f2 <bd_malloc>
...
fileclose(struct file *f)
{
  ...
  bd_free(f);
    ...
    80004490:	352080e7          	jalr	850(ra) # 800067de <bd_free>
}
...
void bit_toggle(char *array,int index){
  ...
  index/=2;
    80006358:	01f5d79b          	srliw	a5,a1,0x1f
    8000635c:	9dbd                	addw	a1,a1,a5
    8000635e:	4015d79b          	sraiw	a5,a1,0x1
  char b = array[index/8];
    80006362:	41f5d59b          	sraiw	a1,a1,0x1f
    80006366:	01d5d59b          	srliw	a1,a1,0x1d
    8000636a:	9fad                	addw	a5,a5,a1
    8000636c:	4037d71b          	sraiw	a4,a5,0x3
    80006370:	953a                	add	a0,a0,a4
  char m = (1 << (index % 8));
    80006372:	8b9d                	andi	a5,a5,7
    80006374:	40b785bb          	subw	a1,a5,a1
    80006378:	4785                	li	a5,1
    8000637a:	00b795bb          	sllw	a1,a5,a1
  array[index/8] = (b ^ m);
    8000637e:	00054783          	lbu	a5,0(a0)
    80006382:	8dbd                	xor	a1,a1,a5
    80006384:	00b50023          	sb	a1,0(a0)
}
    80006388:	6422                	ld	s0,8(sp)
    8000638a:	0141                	addi	sp,sp,16
    8000638c:	8082                	ret

000000008000638e <bit_get>:
...
int bit_get(char *array,int index){
  ...
  index/=2;
    80006394:	01f5d79b          	srliw	a5,a1,0x1f
    80006398:	9dbd                	addw	a1,a1,a5
    8000639a:	4015d79b          	sraiw	a5,a1,0x1
  char b = array[index/8];
  char m = (1 << (index % 8));
    8000639e:	41f5d59b          	sraiw	a1,a1,0x1f
    800063a2:	01d5d59b          	srliw	a1,a1,0x1d
    800063a6:	9fad                	addw	a5,a5,a1
    800063a8:	0077f713          	andi	a4,a5,7
    800063ac:	9f0d                	subw	a4,a4,a1
    800063ae:	4585                	li	a1,1
    800063b0:	00e595bb          	sllw	a1,a1,a4
    800063b4:	0ff5f593          	andi	a1,a1,255
  char b = array[index/8];
    800063b8:	4037d79b          	sraiw	a5,a5,0x3
    800063bc:	97aa                	add	a5,a5,a0
  return (b & m) == m;
    800063be:	0007c503          	lbu	a0,0(a5)
    800063c2:	8d6d                	and	a0,a0,a1
    800063c4:	8d0d                	sub	a0,a0,a1
}
    800063c6:	00153513          	seqz	a0,a0
    800063ca:	6422                	ld	s0,8(sp)
    800063cc:	0141                	addi	sp,sp,16
    800063ce:	8082                	ret

00000000800063d0 <bd_print_vector>:

// Print a bit vector as a list of ranges of 1 bits
void
bd_print_vector(char *vector, int len) {
    800063d0:	715d                	addi	sp,sp,-80
    800063d2:	e486                	sd	ra,72(sp)
    800063d4:	e0a2                	sd	s0,64(sp)
    800063d6:	fc26                	sd	s1,56(sp)
    800063d8:	f84a                	sd	s2,48(sp)
    800063da:	f44e                	sd	s3,40(sp)
    800063dc:	f052                	sd	s4,32(sp)
    800063de:	ec56                	sd	s5,24(sp)
    800063e0:	e85a                	sd	s6,16(sp)
    800063e2:	e45e                	sd	s7,8(sp)
    800063e4:	0880                	addi	s0,sp,80
    800063e6:	8a2e                	mv	s4,a1
  int last, lb;
  
  last = 1;
  lb = 0;
  for (int b = 0; b < len; b++) {
    800063e8:	08b05b63          	blez	a1,8000647e <bd_print_vector+0xae>
    800063ec:	89aa                	mv	s3,a0
    800063ee:	4481                	li	s1,0
  lb = 0;
    800063f0:	4a81                	li	s5,0
  last = 1;
    800063f2:	4905                	li	s2,1
    if (last == bit_isset(vector, b))
      continue;
    if(last == 1)
    800063f4:	4b05                	li	s6,1
      printf(" [%d, %d)", lb, b);
    800063f6:	00001b97          	auipc	s7,0x1
    800063fa:	4aab8b93          	addi	s7,s7,1194 # 800078a0 <userret+0x810>
    800063fe:	a821                	j	80006416 <bd_print_vector+0x46>
    lb = b;
    last = bit_isset(vector, b);
    80006400:	85a6                	mv	a1,s1
    80006402:	854e                	mv	a0,s3
    80006404:	00000097          	auipc	ra,0x0
    80006408:	eb2080e7          	jalr	-334(ra) # 800062b6 <bit_isset>
    8000640c:	892a                	mv	s2,a0
    8000640e:	8aa6                	mv	s5,s1
  for (int b = 0; b < len; b++) {
    80006410:	2485                	addiw	s1,s1,1
    80006412:	029a0463          	beq	s4,s1,8000643a <bd_print_vector+0x6a>
    if (last == bit_isset(vector, b))
    80006416:	85a6                	mv	a1,s1
    80006418:	854e                	mv	a0,s3
    8000641a:	00000097          	auipc	ra,0x0
    8000641e:	e9c080e7          	jalr	-356(ra) # 800062b6 <bit_isset>
    80006422:	ff2507e3          	beq	a0,s2,80006410 <bd_print_vector+0x40>
    if(last == 1)
    80006426:	fd691de3          	bne	s2,s6,80006400 <bd_print_vector+0x30>
      printf(" [%d, %d)", lb, b);
    8000642a:	8626                	mv	a2,s1
    8000642c:	85d6                	mv	a1,s5
    8000642e:	855e                	mv	a0,s7
    80006430:	ffffa097          	auipc	ra,0xffffa
    80006434:	162080e7          	jalr	354(ra) # 80000592 <printf>
    80006438:	b7e1                	j	80006400 <bd_print_vector+0x30>
  }
  if(lb == 0 || last == 1) {
    8000643a:	000a8563          	beqz	s5,80006444 <bd_print_vector+0x74>
    8000643e:	4785                	li	a5,1
    80006440:	00f91c63          	bne	s2,a5,80006458 <bd_print_vector+0x88>
    printf(" [%d, %d)", lb, len);
    80006444:	8652                	mv	a2,s4
    80006446:	85d6                	mv	a1,s5
    80006448:	00001517          	auipc	a0,0x1
    8000644c:	45850513          	addi	a0,a0,1112 # 800078a0 <userret+0x810>
    80006450:	ffffa097          	auipc	ra,0xffffa
    80006454:	142080e7          	jalr	322(ra) # 80000592 <printf>
  }
  printf("\n");
    80006458:	00001517          	auipc	a0,0x1
    8000645c:	d4850513          	addi	a0,a0,-696 # 800071a0 <userret+0x110>
    80006460:	ffffa097          	auipc	ra,0xffffa
    80006464:	132080e7          	jalr	306(ra) # 80000592 <printf>
}
    80006468:	60a6                	ld	ra,72(sp)
    8000646a:	6406                	ld	s0,64(sp)
    8000646c:	74e2                	ld	s1,56(sp)
    8000646e:	7942                	ld	s2,48(sp)
    80006470:	79a2                	ld	s3,40(sp)
    80006472:	7a02                	ld	s4,32(sp)
    80006474:	6ae2                	ld	s5,24(sp)
    80006476:	6b42                	ld	s6,16(sp)
    80006478:	6ba2                	ld	s7,8(sp)
    8000647a:	6161                	addi	sp,sp,80
    8000647c:	8082                	ret
  lb = 0;
    8000647e:	4a81                	li	s5,0
    80006480:	b7d1                	j	80006444 <bd_print_vector+0x74>

0000000080006482 <bd_print>:

// Print buddy's data structures
void
bd_print() {
  for (int k = 0; k < nsizes; k++) {
    80006482:	00022697          	auipc	a3,0x22
    80006486:	bd66a683          	lw	a3,-1066(a3) # 80028058 <nsizes>
    8000648a:	10d05063          	blez	a3,8000658a <bd_print+0x108>
bd_print() {
    8000648e:	711d                	addi	sp,sp,-96
    80006490:	ec86                	sd	ra,88(sp)
    80006492:	e8a2                	sd	s0,80(sp)
    80006494:	e4a6                	sd	s1,72(sp)
    80006496:	e0ca                	sd	s2,64(sp)
    80006498:	fc4e                	sd	s3,56(sp)
    8000649a:	f852                	sd	s4,48(sp)
    8000649c:	f456                	sd	s5,40(sp)
    8000649e:	f05a                	sd	s6,32(sp)
    800064a0:	ec5e                	sd	s7,24(sp)
    800064a2:	e862                	sd	s8,16(sp)
    800064a4:	e466                	sd	s9,8(sp)
    800064a6:	e06a                	sd	s10,0(sp)
    800064a8:	1080                	addi	s0,sp,96
  for (int k = 0; k < nsizes; k++) {
    800064aa:	4481                	li	s1,0
    printf("size %d (blksz %d nblk %d): free list: ", k, BLK_SIZE(k), NBLK(k));
    800064ac:	4a85                	li	s5,1
    800064ae:	4c41                	li	s8,16
    800064b0:	00001b97          	auipc	s7,0x1
    800064b4:	400b8b93          	addi	s7,s7,1024 # 800078b0 <userret+0x820>
    lst_print(&bd_sizes[k].free);
    800064b8:	00022a17          	auipc	s4,0x22
    800064bc:	b98a0a13          	addi	s4,s4,-1128 # 80028050 <bd_sizes>
    printf("  alloc:");
    800064c0:	00001b17          	auipc	s6,0x1
    800064c4:	418b0b13          	addi	s6,s6,1048 # 800078d8 <userret+0x848>
    bd_print_vector(bd_sizes[k].alloc, NBLK(k));
    800064c8:	00022997          	auipc	s3,0x22
    800064cc:	b9098993          	addi	s3,s3,-1136 # 80028058 <nsizes>
    if(k > 0) {
      printf("  split:");
    800064d0:	00001c97          	auipc	s9,0x1
    800064d4:	418c8c93          	addi	s9,s9,1048 # 800078e8 <userret+0x858>
    800064d8:	a801                	j	800064e8 <bd_print+0x66>
  for (int k = 0; k < nsizes; k++) {
    800064da:	0009a683          	lw	a3,0(s3)
    800064de:	0485                	addi	s1,s1,1
    800064e0:	0004879b          	sext.w	a5,s1
    800064e4:	08d7d563          	bge	a5,a3,8000656e <bd_print+0xec>
    800064e8:	0004891b          	sext.w	s2,s1
    printf("size %d (blksz %d nblk %d): free list: ", k, BLK_SIZE(k), NBLK(k));
    800064ec:	36fd                	addiw	a3,a3,-1
    800064ee:	9e85                	subw	a3,a3,s1
    800064f0:	00da96bb          	sllw	a3,s5,a3
    800064f4:	009c1633          	sll	a2,s8,s1
    800064f8:	85ca                	mv	a1,s2
    800064fa:	855e                	mv	a0,s7
    800064fc:	ffffa097          	auipc	ra,0xffffa
    80006500:	096080e7          	jalr	150(ra) # 80000592 <printf>
    lst_print(&bd_sizes[k].free);
    80006504:	00549d13          	slli	s10,s1,0x5
    80006508:	000a3503          	ld	a0,0(s4)
    8000650c:	956a                	add	a0,a0,s10
    8000650e:	00001097          	auipc	ra,0x1
    80006512:	a70080e7          	jalr	-1424(ra) # 80006f7e <lst_print>
    printf("  alloc:");
    80006516:	855a                	mv	a0,s6
    80006518:	ffffa097          	auipc	ra,0xffffa
    8000651c:	07a080e7          	jalr	122(ra) # 80000592 <printf>
    bd_print_vector(bd_sizes[k].alloc, NBLK(k));
    80006520:	0009a583          	lw	a1,0(s3)
    80006524:	35fd                	addiw	a1,a1,-1
    80006526:	412585bb          	subw	a1,a1,s2
    8000652a:	000a3783          	ld	a5,0(s4)
    8000652e:	97ea                	add	a5,a5,s10
    80006530:	00ba95bb          	sllw	a1,s5,a1
    80006534:	6b88                	ld	a0,16(a5)
    80006536:	00000097          	auipc	ra,0x0
    8000653a:	e9a080e7          	jalr	-358(ra) # 800063d0 <bd_print_vector>
    if(k > 0) {
    8000653e:	f9205ee3          	blez	s2,800064da <bd_print+0x58>
      printf("  split:");
    80006542:	8566                	mv	a0,s9
    80006544:	ffffa097          	auipc	ra,0xffffa
    80006548:	04e080e7          	jalr	78(ra) # 80000592 <printf>
      bd_print_vector(bd_sizes[k].split, NBLK(k));
    8000654c:	0009a583          	lw	a1,0(s3)
    80006550:	35fd                	addiw	a1,a1,-1
    80006552:	412585bb          	subw	a1,a1,s2
    80006556:	000a3783          	ld	a5,0(s4)
    8000655a:	9d3e                	add	s10,s10,a5
    8000655c:	00ba95bb          	sllw	a1,s5,a1
    80006560:	018d3503          	ld	a0,24(s10)
    80006564:	00000097          	auipc	ra,0x0
    80006568:	e6c080e7          	jalr	-404(ra) # 800063d0 <bd_print_vector>
    8000656c:	b7bd                	j	800064da <bd_print+0x58>
    }
  }
}
    8000656e:	60e6                	ld	ra,88(sp)
    80006570:	6446                	ld	s0,80(sp)
    80006572:	64a6                	ld	s1,72(sp)
    80006574:	6906                	ld	s2,64(sp)
    80006576:	79e2                	ld	s3,56(sp)
    80006578:	7a42                	ld	s4,48(sp)
    8000657a:	7aa2                	ld	s5,40(sp)
    8000657c:	7b02                	ld	s6,32(sp)
    8000657e:	6be2                	ld	s7,24(sp)
    80006580:	6c42                	ld	s8,16(sp)
    80006582:	6ca2                	ld	s9,8(sp)
    80006584:	6d02                	ld	s10,0(sp)
    80006586:	6125                	addi	sp,sp,96
    80006588:	8082                	ret
    8000658a:	8082                	ret

000000008000658c <firstk>:
...
firstk(uint64 n) {
  ...
  while (size < n) {
    80006592:	47c1                	li	a5,16
    80006594:	00a7fb63          	bgeu	a5,a0,800065aa <firstk+0x1e>
    80006598:	872a                	mv	a4,a0
  int k = 0;
    8000659a:	4501                	li	a0,0
    k++;
    8000659c:	2505                	addiw	a0,a0,1
    size *= 2;
    8000659e:	0786                	slli	a5,a5,0x1
  while (size < n) {
    800065a0:	fee7eee3          	bltu	a5,a4,8000659c <firstk+0x10>
  }
  return k;
}
    800065a4:	6422                	ld	s0,8(sp)
    800065a6:	0141                	addi	sp,sp,16
    800065a8:	8082                	ret
  int k = 0;
    800065aa:	4501                	li	a0,0
    800065ac:	bfe5                	j	800065a4 <firstk+0x18>

00000000800065ae <blk_index>:

// Compute the block index for address p at size k
int
blk_index(int k, char *p) {
    800065ae:	1141                	addi	sp,sp,-16
    800065b0:	e422                	sd	s0,8(sp)
    800065b2:	0800                	addi	s0,sp,16
  int n = p - (char *) bd_base;
  return n / BLK_SIZE(k);
    800065b4:	00022797          	auipc	a5,0x22
    800065b8:	a947b783          	ld	a5,-1388(a5) # 80028048 <bd_base>
...
void *addr(int k, int bi) {
  ...
  int n = bi * BLK_SIZE(k);
    ...
    800065da:	00a797b3          	sll	a5,a5,a0
  return (char *) bd_base + n;
    800065de:	02b787bb          	mulw	a5,a5,a1
}
    800065e2:	00022517          	auipc	a0,0x22
    800065e6:	a6653503          	ld	a0,-1434(a0) # 80028048 <bd_base>
    800065ea:	953e                	add	a0,a0,a5
    800065ec:	6422                	ld	s0,8(sp)
    800065ee:	0141                	addi	sp,sp,16
    800065f0:	8082                	ret

00000000800065f2 <bd_malloc>:

// allocate nbytes, but malloc won't return anything smaller than LEAF_SIZE
void *
bd_malloc(uint64 nbytes)
{
    800065f2:	7159                	addi	sp,sp,-112
    ...
    8000660c:	e46e                	sd	s11,8(sp)
    8000660e:	1880                	addi	s0,sp,112
    80006610:	84aa                	mv	s1,a0
  int fk, k;

  acquire(&lock);
    80006612:	00022517          	auipc	a0,0x22
    80006616:	9ee50513          	addi	a0,a0,-1554 # 80028000 <lock>
    8000661a:	ffffa097          	auipc	ra,0xffffa
    8000661e:	3a2080e7          	jalr	930(ra) # 800009bc <acquire>

  // Find a free block >= nbytes, starting with smallest k possible
  fk = firstk(nbytes);
    80006622:	8526                	mv	a0,s1
    80006624:	00000097          	auipc	ra,0x0
    80006628:	f68080e7          	jalr	-152(ra) # 8000658c <firstk>
  for (k = fk; k < nsizes; k++) {
    8000662c:	00022797          	auipc	a5,0x22
    80006630:	a2c7a783          	lw	a5,-1492(a5) # 80028058 <nsizes>
    80006634:	02f55d63          	bge	a0,a5,8000666e <bd_malloc+0x7c>
    80006638:	8c2a                	mv	s8,a0
    8000663a:	00551913          	slli	s2,a0,0x5
    8000663e:	84aa                	mv	s1,a0
    if(!lst_empty(&bd_sizes[k].free))
    80006640:	00022997          	auipc	s3,0x22
    80006644:	a1098993          	addi	s3,s3,-1520 # 80028050 <bd_sizes>
  for (k = fk; k < nsizes; k++) {
    80006648:	00022a17          	auipc	s4,0x22
    8000664c:	a10a0a13          	addi	s4,s4,-1520 # 80028058 <nsizes>
    if(!lst_empty(&bd_sizes[k].free))
    80006650:	0009b503          	ld	a0,0(s3)
    80006654:	954a                	add	a0,a0,s2
    80006656:	00001097          	auipc	ra,0x1
    8000665a:	8ae080e7          	jalr	-1874(ra) # 80006f04 <lst_empty>
    8000665e:	c115                	beqz	a0,80006682 <bd_malloc+0x90>
  for (k = fk; k < nsizes; k++) {
    80006660:	2485                	addiw	s1,s1,1
    80006662:	02090913          	addi	s2,s2,32
    80006666:	000a2783          	lw	a5,0(s4)
    8000666a:	fef4c3e3          	blt	s1,a5,80006650 <bd_malloc+0x5e>
      break;
  }
  if(k >= nsizes) { // No free blocks?
    release(&lock);
    8000666e:	00022517          	auipc	a0,0x22
    80006672:	99250513          	addi	a0,a0,-1646 # 80028000 <lock>
    80006676:	ffffa097          	auipc	ra,0xffffa
    8000667a:	3ae080e7          	jalr	942(ra) # 80000a24 <release>
    return 0;
    8000667e:	4b01                	li	s6,0
    80006680:	a0e1                	j	80006748 <bd_malloc+0x156>
  if(k >= nsizes) { // No free blocks?
    80006682:	00022797          	auipc	a5,0x22
    80006686:	9d67a783          	lw	a5,-1578(a5) # 80028058 <nsizes>
    8000668a:	fef4d2e3          	bge	s1,a5,8000666e <bd_malloc+0x7c>
  }

  // Found a block; pop it and potentially split it.
  char *p = lst_pop(&bd_sizes[k].free);
    8000668e:	00549993          	slli	s3,s1,0x5
    80006692:	00022917          	auipc	s2,0x22
    80006696:	9be90913          	addi	s2,s2,-1602 # 80028050 <bd_sizes>
    8000669a:	00093503          	ld	a0,0(s2)
    8000669e:	954e                	add	a0,a0,s3
    800066a0:	00001097          	auipc	ra,0x1
    800066a4:	890080e7          	jalr	-1904(ra) # 80006f30 <lst_pop>
    800066a8:	8b2a                	mv	s6,a0
  return n / BLK_SIZE(k);
    800066aa:	00022597          	auipc	a1,0x22
    800066ae:	99e5b583          	ld	a1,-1634(a1) # 80028048 <bd_base>
    800066b2:	40b505bb          	subw	a1,a0,a1
    800066b6:	47c1                	li	a5,16
    800066b8:	009797b3          	sll	a5,a5,s1
    800066bc:	02f5c5b3          	div	a1,a1,a5
  // bit_set(bd_sizes[k].alloc, blk_index(k, p));
  bit_toggle(bd_sizes[k].alloc, blk_index(k, p));
    800066c0:	00093783          	ld	a5,0(s2)
    800066c4:	97ce                	add	a5,a5,s3
    800066c6:	2581                	sext.w	a1,a1
    800066c8:	6b88                	ld	a0,16(a5)
    800066ca:	00000097          	auipc	ra,0x0
    800066ce:	c88080e7          	jalr	-888(ra) # 80006352 <bit_toggle>
  for(; k > fk; k--) {
    800066d2:	069c5363          	bge	s8,s1,80006738 <bd_malloc+0x146>
    // split a block at size k and mark one half allocated at size k-1
    // and put the buddy on the free list at size k-1
    char *q = p + BLK_SIZE(k-1);   // p's buddy
    800066d6:	4bc1                	li	s7,16
    bit_set(bd_sizes[k].split, blk_index(k, p));
    800066d8:	8dca                	mv	s11,s2
  int n = p - (char *) bd_base;
    800066da:	00022d17          	auipc	s10,0x22
    800066de:	96ed0d13          	addi	s10,s10,-1682 # 80028048 <bd_base>
    char *q = p + BLK_SIZE(k-1);   // p's buddy
    800066e2:	85a6                	mv	a1,s1
    800066e4:	34fd                	addiw	s1,s1,-1
    800066e6:	009b9ab3          	sll	s5,s7,s1
    800066ea:	015b0cb3          	add	s9,s6,s5
    bit_set(bd_sizes[k].split, blk_index(k, p));
    800066ee:	000dba03          	ld	s4,0(s11) # 1000 <_entry-0x7ffff000>
  int n = p - (char *) bd_base;
    800066f2:	000d3903          	ld	s2,0(s10)
  return n / BLK_SIZE(k);
    800066f6:	412b093b          	subw	s2,s6,s2
    800066fa:	00bb95b3          	sll	a1,s7,a1
    800066fe:	02b945b3          	div	a1,s2,a1
    bit_set(bd_sizes[k].split, blk_index(k, p));
    80006702:	013a07b3          	add	a5,s4,s3
    80006706:	2581                	sext.w	a1,a1
    80006708:	6f88                	ld	a0,24(a5)
    8000670a:	00000097          	auipc	ra,0x0
    8000670e:	be4080e7          	jalr	-1052(ra) # 800062ee <bit_set>
    // bit_set(bd_sizes[k-1].alloc, blk_index(k-1, p));
    bit_toggle(bd_sizes[k-1].alloc, blk_index(k-1, p));
    80006712:	1981                	addi	s3,s3,-32
    80006714:	9a4e                	add	s4,s4,s3
  return n / BLK_SIZE(k);
    80006716:	035945b3          	div	a1,s2,s5
    bit_toggle(bd_sizes[k-1].alloc, blk_index(k-1, p));
    8000671a:	2581                	sext.w	a1,a1
    8000671c:	010a3503          	ld	a0,16(s4)
    80006720:	00000097          	auipc	ra,0x0
    80006724:	c32080e7          	jalr	-974(ra) # 80006352 <bit_toggle>
    lst_push(&bd_sizes[k-1].free, q);
    80006728:	85e6                	mv	a1,s9
    8000672a:	8552                	mv	a0,s4
    8000672c:	00001097          	auipc	ra,0x1
    80006730:	83a080e7          	jalr	-1990(ra) # 80006f66 <lst_push>
  for(; k > fk; k--) {
    80006734:	fb8497e3          	bne	s1,s8,800066e2 <bd_malloc+0xf0>
  }
  release(&lock);
    80006738:	00022517          	auipc	a0,0x22
    8000673c:	8c850513          	addi	a0,a0,-1848 # 80028000 <lock>
    80006740:	ffffa097          	auipc	ra,0xffffa
    80006744:	2e4080e7          	jalr	740(ra) # 80000a24 <release>

  return p;
}
    80006748:	855a                	mv	a0,s6
    8000674a:	70a6                	ld	ra,104(sp)
    8000674c:	7406                	ld	s0,96(sp)
    8000674e:	64e6                	ld	s1,88(sp)
    80006750:	6946                	ld	s2,80(sp)
    80006752:	69a6                	ld	s3,72(sp)
    80006754:	6a06                	ld	s4,64(sp)
    80006756:	7ae2                	ld	s5,56(sp)
    80006758:	7b42                	ld	s6,48(sp)
    8000675a:	7ba2                	ld	s7,40(sp)
    8000675c:	7c02                	ld	s8,32(sp)
    8000675e:	6ce2                	ld	s9,24(sp)
    80006760:	6d42                	ld	s10,16(sp)
    80006762:	6da2                	ld	s11,8(sp)
    80006764:	6165                	addi	sp,sp,112
    80006766:	8082                	ret

0000000080006768 <size>:
...
size(char *p) {
    ...
    8000676c:	f822                	sd	s0,48(sp)
    8000676e:	f426                	sd	s1,40(sp)
    80006770:	f04a                	sd	s2,32(sp)
    80006772:	ec4e                	sd	s3,24(sp)
    80006774:	e852                	sd	s4,16(sp)
    80006776:	e456                	sd	s5,8(sp)
    80006778:	e05a                	sd	s6,0(sp)
    8000677a:	0080                	addi	s0,sp,64
  for (int k = 0; k < nsizes; k++) {
    8000677c:	00022a97          	auipc	s5,0x22
    80006780:	8dcaaa83          	lw	s5,-1828(s5) # 80028058 <nsizes>
  return n / BLK_SIZE(k);
    80006784:	00022a17          	auipc	s4,0x22
    80006788:	8c4a3a03          	ld	s4,-1852(s4) # 80028048 <bd_base>
    8000678c:	41450a3b          	subw	s4,a0,s4
    80006790:	00022497          	auipc	s1,0x22
    80006794:	8c04b483          	ld	s1,-1856(s1) # 80028050 <bd_sizes>
    80006798:	03848493          	addi	s1,s1,56
  for (int k = 0; k < nsizes; k++) {
    8000679c:	4901                	li	s2,0
  return n / BLK_SIZE(k);
    8000679e:	4b41                	li	s6,16
  for (int k = 0; k < nsizes; k++) {
    800067a0:	03595363          	bge	s2,s5,800067c6 <size+0x5e>
    if(bit_isset(bd_sizes[k+1].split, blk_index(k+1, p))) {
    800067a4:	0019099b          	addiw	s3,s2,1
  return n / BLK_SIZE(k);
    800067a8:	013b15b3          	sll	a1,s6,s3
    800067ac:	02ba45b3          	div	a1,s4,a1
    if(bit_isset(bd_sizes[k+1].split, blk_index(k+1, p))) {
    800067b0:	2581                	sext.w	a1,a1
    800067b2:	6088                	ld	a0,0(s1)
    800067b4:	00000097          	auipc	ra,0x0
    800067b8:	b02080e7          	jalr	-1278(ra) # 800062b6 <bit_isset>
    800067bc:	02048493          	addi	s1,s1,32
    800067c0:	e501                	bnez	a0,800067c8 <size+0x60>
  for (int k = 0; k < nsizes; k++) {
    800067c2:	894e                	mv	s2,s3
    800067c4:	bff1                	j	800067a0 <size+0x38>
      return k;
    }
  }
  return 0;
    800067c6:	4901                	li	s2,0
}
    800067c8:	854a                	mv	a0,s2
    800067ca:	70e2                	ld	ra,56(sp)
    800067cc:	7442                	ld	s0,48(sp)
    800067ce:	74a2                	ld	s1,40(sp)
    800067d0:	7902                	ld	s2,32(sp)
    800067d2:	69e2                	ld	s3,24(sp)
    800067d4:	6a42                	ld	s4,16(sp)
    800067d6:	6aa2                	ld	s5,8(sp)
    800067d8:	6b02                	ld	s6,0(sp)
    800067da:	6121                	addi	sp,sp,64
    800067dc:	8082                	ret

00000000800067de <bd_free>:

// Free memory pointed to by p, which was earlier allocated using
// bd_malloc.
void
bd_free(void *p) {
    800067de:	7159                	addi	sp,sp,-112
    800067e0:	f486                	sd	ra,104(sp)
    800067e2:	f0a2                	sd	s0,96(sp)
    800067e4:	eca6                	sd	s1,88(sp)
    800067e6:	e8ca                	sd	s2,80(sp)
    800067e8:	e4ce                	sd	s3,72(sp)
    800067ea:	e0d2                	sd	s4,64(sp)
    800067ec:	fc56                	sd	s5,56(sp)
    800067ee:	f85a                	sd	s6,48(sp)
    800067f0:	f45e                	sd	s7,40(sp)
    800067f2:	f062                	sd	s8,32(sp)
    800067f4:	ec66                	sd	s9,24(sp)
    800067f6:	e86a                	sd	s10,16(sp)
    800067f8:	e46e                	sd	s11,8(sp)
    800067fa:	1880                	addi	s0,sp,112
    800067fc:	8baa                	mv	s7,a0
  void *q;
  int k;

  acquire(&lock);
    800067fe:	00022517          	auipc	a0,0x22
    80006802:	80250513          	addi	a0,a0,-2046 # 80028000 <lock>
    80006806:	ffffa097          	auipc	ra,0xffffa
    8000680a:	1b6080e7          	jalr	438(ra) # 800009bc <acquire>
  for (k = size(p); k < MAXSIZE; k++) {
    8000680e:	855e                	mv	a0,s7
    80006810:	00000097          	auipc	ra,0x0
    80006814:	f58080e7          	jalr	-168(ra) # 80006768 <size>
    80006818:	84aa                	mv	s1,a0
    8000681a:	00022797          	auipc	a5,0x22
    8000681e:	83e7a783          	lw	a5,-1986(a5) # 80028058 <nsizes>
    80006822:	37fd                	addiw	a5,a5,-1
    80006824:	0cf55063          	bge	a0,a5,800068e4 <bd_free+0x106>
    80006828:	00150a93          	addi	s5,a0,1
    8000682c:	0a96                	slli	s5,s5,0x5
  int n = p - (char *) bd_base;
    8000682e:	00022d97          	auipc	s11,0x22
    80006832:	81ad8d93          	addi	s11,s11,-2022 # 80028048 <bd_base>
  return n / BLK_SIZE(k);
    80006836:	4d41                	li	s10,16
    int bi = blk_index(k, p);
    int buddy = (bi % 2 == 0) ? bi+1 : bi-1;
    // bit_clear(bd_sizes[k].alloc, bi);  // free p at size k
    bit_toggle(bd_sizes[k].alloc, bi);  // free p at size k
    80006838:	00022c97          	auipc	s9,0x22
    8000683c:	818c8c93          	addi	s9,s9,-2024 # 80028050 <bd_sizes>
    80006840:	a081                	j	80006880 <bd_free+0xa2>
    int buddy = (bi % 2 == 0) ? bi+1 : bi-1;
    80006842:	fffb0c1b          	addiw	s8,s6,-1
    80006846:	a899                	j	8000689c <bd_free+0xbe>
    if(buddy % 2 == 0) {
      p = q;
    }
    ...
    80006848:	2485                	addiw	s1,s1,1
  int n = p - (char *) bd_base;
    8000684a:	000db583          	ld	a1,0(s11)
  return n / BLK_SIZE(k);
    8000684e:	40bb85bb          	subw	a1,s7,a1
    80006852:	009d17b3          	sll	a5,s10,s1
    80006856:	02f5c5b3          	div	a1,a1,a5
    bit_clear(bd_sizes[k+1].split, blk_index(k+1, p));
    8000685a:	000cb783          	ld	a5,0(s9)
    8000685e:	97d6                	add	a5,a5,s5
    80006860:	2581                	sext.w	a1,a1
    80006862:	6f88                	ld	a0,24(a5)
    80006864:	00000097          	auipc	ra,0x0
    80006868:	aba080e7          	jalr	-1350(ra) # 8000631e <bit_clear>
  for (k = size(p); k < MAXSIZE; k++) {
    8000686c:	020a8a93          	addi	s5,s5,32
    80006870:	00021797          	auipc	a5,0x21
    80006874:	7e878793          	addi	a5,a5,2024 # 80028058 <nsizes>
    80006878:	439c                	lw	a5,0(a5)
    8000687a:	37fd                	addiw	a5,a5,-1
    8000687c:	06f4d463          	bge	s1,a5,800068e4 <bd_free+0x106>
  int n = p - (char *) bd_base;
    80006880:	000db903          	ld	s2,0(s11)
  return n / BLK_SIZE(k);
    80006884:	009d1a33          	sll	s4,s10,s1
    80006888:	412b87bb          	subw	a5,s7,s2
    8000688c:	0347c7b3          	div	a5,a5,s4
    80006890:	00078b1b          	sext.w	s6,a5
    int buddy = (bi % 2 == 0) ? bi+1 : bi-1;
    80006894:	8b85                	andi	a5,a5,1
    80006896:	f7d5                	bnez	a5,80006842 <bd_free+0x64>
    80006898:	001b0c1b          	addiw	s8,s6,1
    bit_toggle(bd_sizes[k].alloc, bi);  // free p at size k
    8000689c:	fe0a8993          	addi	s3,s5,-32
    800068a0:	000cb783          	ld	a5,0(s9)
    800068a4:	99be                	add	s3,s3,a5
    800068a6:	85da                	mv	a1,s6
    800068a8:	0109b503          	ld	a0,16(s3)
    800068ac:	00000097          	auipc	ra,0x0
    800068b0:	aa6080e7          	jalr	-1370(ra) # 80006352 <bit_toggle>
    if (bit_get(bd_sizes[k].alloc, bi)) {  // is buddy allocated?
    800068b4:	85da                	mv	a1,s6
    800068b6:	0109b503          	ld	a0,16(s3)
    800068ba:	00000097          	auipc	ra,0x0
    800068be:	ad4080e7          	jalr	-1324(ra) # 8000638e <bit_get>
    800068c2:	e10d                	bnez	a0,800068e4 <bd_free+0x106>
  int n = bi * BLK_SIZE(k);
    800068c4:	000c099b          	sext.w	s3,s8
  return (char *) bd_base + n;
    800068c8:	038a0a3b          	mulw	s4,s4,s8
    800068cc:	9952                	add	s2,s2,s4
    lst_remove(q);    // remove buddy from free list
    800068ce:	854a                	mv	a0,s2
    800068d0:	00000097          	auipc	ra,0x0
    800068d4:	64a080e7          	jalr	1610(ra) # 80006f1a <lst_remove>
    if(buddy % 2 == 0) {
    800068d8:	0019f993          	andi	s3,s3,1
    800068dc:	f60996e3          	bnez	s3,80006848 <bd_free+0x6a>
      p = q;
    800068e0:	8bca                	mv	s7,s2
    800068e2:	b79d                	j	80006848 <bd_free+0x6a>
  }
  lst_push(&bd_sizes[k].free, p);
    800068e4:	0496                	slli	s1,s1,0x5
    800068e6:	85de                	mv	a1,s7
    800068e8:	00021517          	auipc	a0,0x21
    800068ec:	76853503          	ld	a0,1896(a0) # 80028050 <bd_sizes>
    800068f0:	9526                	add	a0,a0,s1
    800068f2:	00000097          	auipc	ra,0x0
    800068f6:	674080e7          	jalr	1652(ra) # 80006f66 <lst_push>
  release(&lock);
    800068fa:	00021517          	auipc	a0,0x21
    800068fe:	70650513          	addi	a0,a0,1798 # 80028000 <lock>
    80006902:	ffffa097          	auipc	ra,0xffffa
    80006906:	122080e7          	jalr	290(ra) # 80000a24 <release>
}
...
0000000080006928 <blk_index_next>:
...
blk_index_next(int k, char *p) {
    ...
    8000692c:	0800                	addi	s0,sp,16
  int n = (p - (char *) bd_base) / BLK_SIZE(k);
    8000692e:	00021797          	auipc	a5,0x21
    80006932:	71a7b783          	ld	a5,1818(a5) # 80028048 <bd_base>
    80006936:	8d9d                	sub	a1,a1,a5
    80006938:	47c1                	li	a5,16
    8000693a:	00a797b3          	sll	a5,a5,a0
    8000693e:	02f5c533          	div	a0,a1,a5
    80006942:	2501                	sext.w	a0,a0
  if((p - (char*) bd_base) % BLK_SIZE(k) != 0)
    80006944:	02f5e5b3          	rem	a1,a1,a5
    80006948:	c191                	beqz	a1,8000694c <blk_index_next+0x24>
      n++;
    8000694a:	2505                	addiw	a0,a0,1
  return n ;
}
    8000694c:	6422                	ld	s0,8(sp)
    8000694e:	0141                	addi	sp,sp,16
    80006950:	8082                	ret

0000000080006952 <log2>:

int
log2(uint64 n) {
    80006952:	1141                	addi	sp,sp,-16
    80006954:	e422                	sd	s0,8(sp)
    80006956:	0800                	addi	s0,sp,16
  int k = 0;
  while (n > 1) {
    80006958:	4705                	li	a4,1
    8000695a:	00a77b63          	bgeu	a4,a0,80006970 <log2+0x1e>
    8000695e:	87aa                	mv	a5,a0
  int k = 0;
    80006960:	4501                	li	a0,0
    k++;
    80006962:	2505                	addiw	a0,a0,1
    n = n >> 1;
    80006964:	8385                	srli	a5,a5,0x1
  while (n > 1) {
    80006966:	fef76ee3          	bltu	a4,a5,80006962 <log2+0x10>
  }
  return k;
}
    8000696a:	6422                	ld	s0,8(sp)
    8000696c:	0141                	addi	sp,sp,16
    8000696e:	8082                	ret
  int k = 0;
    80006970:	4501                	li	a0,0
    80006972:	bfe5                	j	8000696a <log2+0x18>

0000000080006974 <bd_mark>:

// Mark memory from [start, stop), starting at size 0, as allocated. 
void
bd_mark(void *start, void *stop)
{
    80006974:	711d                	addi	sp,sp,-96
    80006976:	ec86                	sd	ra,88(sp)
    80006978:	e8a2                	sd	s0,80(sp)
    8000697a:	e4a6                	sd	s1,72(sp)
    8000697c:	e0ca                	sd	s2,64(sp)
    8000697e:	fc4e                	sd	s3,56(sp)
    80006980:	f852                	sd	s4,48(sp)
    80006982:	f456                	sd	s5,40(sp)
    80006984:	f05a                	sd	s6,32(sp)
    80006986:	ec5e                	sd	s7,24(sp)
    80006988:	e862                	sd	s8,16(sp)
    8000698a:	e466                	sd	s9,8(sp)
    8000698c:	e06a                	sd	s10,0(sp)
    8000698e:	1080                	addi	s0,sp,96
  int bi, bj;

  if (((uint64) start % LEAF_SIZE != 0) || ((uint64) stop % LEAF_SIZE != 0))
    80006990:	00b56933          	or	s2,a0,a1
    80006994:	00f97913          	andi	s2,s2,15
    80006998:	04091263          	bnez	s2,800069dc <bd_mark+0x68>
    8000699c:	8b2a                	mv	s6,a0
    8000699e:	8bae                	mv	s7,a1
    panic("bd_mark");

  for (int k = 0; k < nsizes; k++) {
    800069a0:	00021c17          	auipc	s8,0x21
    800069a4:	6b8c2c03          	lw	s8,1720(s8) # 80028058 <nsizes>
    800069a8:	4981                	li	s3,0
  int n = p - (char *) bd_base;
    800069aa:	00021d17          	auipc	s10,0x21
    800069ae:	69ed0d13          	addi	s10,s10,1694 # 80028048 <bd_base>
  return n / BLK_SIZE(k);
    800069b2:	4cc1                	li	s9,16
    ...
    800069b4:	00021a97          	auipc	s5,0x21
    800069b8:	69ca8a93          	addi	s5,s5,1692 # 80028050 <bd_sizes>
  for (int k = 0; k < nsizes; k++) {
    800069bc:	07804563          	bgtz	s8,80006a26 <bd_mark+0xb2>
      }
    ...
    800069c0:	60e6                	ld	ra,88(sp)
    800069c2:	6446                	ld	s0,80(sp)
    800069c4:	64a6                	ld	s1,72(sp)
    800069c6:	6906                	ld	s2,64(sp)
    800069c8:	79e2                	ld	s3,56(sp)
    800069ca:	7a42                	ld	s4,48(sp)
    800069cc:	7aa2                	ld	s5,40(sp)
    800069ce:	7b02                	ld	s6,32(sp)
    800069d0:	6be2                	ld	s7,24(sp)
    800069d2:	6c42                	ld	s8,16(sp)
    800069d4:	6ca2                	ld	s9,8(sp)
    800069d6:	6d02                	ld	s10,0(sp)
    800069d8:	6125                	addi	sp,sp,96
    800069da:	8082                	ret
    panic("bd_mark");
    800069dc:	00001517          	auipc	a0,0x1
    800069e0:	f1c50513          	addi	a0,a0,-228 # 800078f8 <userret+0x868>
    800069e4:	ffffa097          	auipc	ra,0xffffa
    800069e8:	b64080e7          	jalr	-1180(ra) # 80000548 <panic>
      bit_toggle(bd_sizes[k].alloc,bi);
    800069ec:	000ab783          	ld	a5,0(s5)
    800069f0:	97ca                	add	a5,a5,s2
    800069f2:	85a6                	mv	a1,s1
    800069f4:	6b88                	ld	a0,16(a5)
    800069f6:	00000097          	auipc	ra,0x0
    800069fa:	95c080e7          	jalr	-1700(ra) # 80006352 <bit_toggle>
    for(; bi < bj; bi++) {
    800069fe:	2485                	addiw	s1,s1,1
    80006a00:	009a0e63          	beq	s4,s1,80006a1c <bd_mark+0xa8>
      if(k > 0) {
    80006a04:	ff3054e3          	blez	s3,800069ec <bd_mark+0x78>
        bit_set(bd_sizes[k].split, bi);
    80006a08:	000ab783          	ld	a5,0(s5)
    80006a0c:	97ca                	add	a5,a5,s2
    80006a0e:	85a6                	mv	a1,s1
    80006a10:	6f88                	ld	a0,24(a5)
    80006a12:	00000097          	auipc	ra,0x0
    80006a16:	8dc080e7          	jalr	-1828(ra) # 800062ee <bit_set>
    80006a1a:	bfc9                	j	800069ec <bd_mark+0x78>
  for (int k = 0; k < nsizes; k++) {
    80006a1c:	2985                	addiw	s3,s3,1
    80006a1e:	02090913          	addi	s2,s2,32
    80006a22:	f9898fe3          	beq	s3,s8,800069c0 <bd_mark+0x4c>
  int n = p - (char *) bd_base;
    80006a26:	000d3483          	ld	s1,0(s10)
  return n / BLK_SIZE(k);
    80006a2a:	409b04bb          	subw	s1,s6,s1
    80006a2e:	013c97b3          	sll	a5,s9,s3
    80006a32:	02f4c4b3          	div	s1,s1,a5
    80006a36:	2481                	sext.w	s1,s1
    bj = blk_index_next(k, stop);
    80006a38:	85de                	mv	a1,s7
    80006a3a:	854e                	mv	a0,s3
    80006a3c:	00000097          	auipc	ra,0x0
    80006a40:	eec080e7          	jalr	-276(ra) # 80006928 <blk_index_next>
    80006a44:	8a2a                	mv	s4,a0
    for(; bi < bj; bi++) {
    80006a46:	faa4cfe3          	blt	s1,a0,80006a04 <bd_mark+0x90>
    80006a4a:	bfc9                	j	80006a1c <bd_mark+0xa8>

0000000080006a4c <addr_in_range>:
...
int addr_in_range(void *addr,void *left,void *right,int size){
  ...
  return (addr>=left)&&((addr+size)<right);
    80006a52:	00b56863          	bltu	a0,a1,80006a62 <addr_in_range+0x16>
    80006a56:	9536                	add	a0,a0,a3
    80006a58:	00c53533          	sltu	a0,a0,a2
}
    80006a5c:	6422                	ld	s0,8(sp)
    80006a5e:	0141                	addi	sp,sp,16
    80006a60:	8082                	ret
  return (addr>=left)&&((addr+size)<right);
    80006a62:	4501                	li	a0,0
    80006a64:	bfe5                	j	80006a5c <addr_in_range+0x10>

0000000080006a66 <bd_initfree_pair>:

// If a block is marked as allocated and the buddy is free, put the
// buddy on the free list at size k.
int
bd_initfree_pair(int k, int bi,void *left,void *right) {
    80006a66:	715d                	addi	sp,sp,-80
    80006a68:	e486                	sd	ra,72(sp)
    80006a6a:	e0a2                	sd	s0,64(sp)
    80006a6c:	fc26                	sd	s1,56(sp)
    80006a6e:	f84a                	sd	s2,48(sp)
    80006a70:	f44e                	sd	s3,40(sp)
    80006a72:	f052                	sd	s4,32(sp)
    80006a74:	ec56                	sd	s5,24(sp)
    80006a76:	e85a                	sd	s6,16(sp)
    80006a78:	e45e                	sd	s7,8(sp)
    80006a7a:	0880                	addi	s0,sp,80
    80006a7c:	8b2a                	mv	s6,a0
    80006a7e:	89b2                	mv	s3,a2
    80006a80:	8a36                	mv	s4,a3
  int buddy = (bi % 2 == 0) ? bi+1 : bi-1;
    80006a82:	00058b9b          	sext.w	s7,a1
    80006a86:	0015f793          	andi	a5,a1,1
    80006a8a:	ebb1                	bnez	a5,80006ade <bd_initfree_pair+0x78>
    80006a8c:	00158a9b          	addiw	s5,a1,1
  int free = 0;
  // if(bit_isset(bd_sizes[k].alloc, bi) !=  bit_isset(bd_sizes[k].alloc, buddy)) {
  if(bit_get(bd_sizes[k].alloc,bi)){
    80006a90:	005b1793          	slli	a5,s6,0x5
    80006a94:	00021917          	auipc	s2,0x21
    80006a98:	5bc93903          	ld	s2,1468(s2) # 80028050 <bd_sizes>
    80006a9c:	993e                	add	s2,s2,a5
    80006a9e:	01093503          	ld	a0,16(s2)
    80006aa2:	00000097          	auipc	ra,0x0
    80006aa6:	8ec080e7          	jalr	-1812(ra) # 8000638e <bit_get>
    80006aaa:	84aa                	mv	s1,a0
    80006aac:	c529                	beqz	a0,80006af6 <bd_initfree_pair+0x90>
    // one of the pair is free
    free = BLK_SIZE(k);
    80006aae:	44c1                	li	s1,16
    80006ab0:	016494b3          	sll	s1,s1,s6
    80006ab4:	2481                	sext.w	s1,s1
  int n = bi * BLK_SIZE(k);
    80006ab6:	8726                	mv	a4,s1
  return (char *) bd_base + n;
    80006ab8:	00021797          	auipc	a5,0x21
    80006abc:	5907b783          	ld	a5,1424(a5) # 80028048 <bd_base>
    80006ac0:	029b85bb          	mulw	a1,s7,s1
    80006ac4:	95be                	add	a1,a1,a5
  return (addr>=left)&&((addr+size)<right);
    80006ac6:	0135ef63          	bltu	a1,s3,80006ae4 <bd_initfree_pair+0x7e>
    80006aca:	009586b3          	add	a3,a1,s1
    80006ace:	0146fb63          	bgeu	a3,s4,80006ae4 <bd_initfree_pair+0x7e>
    ...
    80006ad8:	492080e7          	jalr	1170(ra) # 80006f66 <lst_push>
    80006adc:	a829                	j	80006af6 <bd_initfree_pair+0x90>
  int buddy = (bi % 2 == 0) ? bi+1 : bi-1;
    80006ade:	fff58a9b          	addiw	s5,a1,-1
    80006ae2:	b77d                	j	80006a90 <bd_initfree_pair+0x2a>
  return (char *) bd_base + n;
    80006ae4:	02ea8abb          	mulw	s5,s5,a4
    }else{
      lst_push(&bd_sizes[k].free, addr(k, buddy)); 
    80006ae8:	015785b3          	add	a1,a5,s5
    80006aec:	854a                	mv	a0,s2
    80006aee:	00000097          	auipc	ra,0x0
    80006af2:	478080e7          	jalr	1144(ra) # 80006f66 <lst_push>
    }
    
  }
  return free;
}
    80006af6:	8526                	mv	a0,s1
    80006af8:	60a6                	ld	ra,72(sp)
    80006afa:	6406                	ld	s0,64(sp)
    80006afc:	74e2                	ld	s1,56(sp)
    80006afe:	7942                	ld	s2,48(sp)
    80006b00:	79a2                	ld	s3,40(sp)
    80006b02:	7a02                	ld	s4,32(sp)
    80006b04:	6ae2                	ld	s5,24(sp)
    80006b06:	6b42                	ld	s6,16(sp)
    80006b08:	6ba2                	ld	s7,8(sp)
    80006b0a:	6161                	addi	sp,sp,80
    80006b0c:	8082                	ret

0000000080006b0e <bd_initfree>:
...
bd_initfree(void *bd_left, void *bd_right) {
    80006b0e:	711d                	addi	sp,sp,-96
    80006b10:	ec86                	sd	ra,88(sp)
    80006b12:	e8a2                	sd	s0,80(sp)
    80006b14:	e4a6                	sd	s1,72(sp)
    80006b16:	e0ca                	sd	s2,64(sp)
    80006b18:	fc4e                	sd	s3,56(sp)
    80006b1a:	f852                	sd	s4,48(sp)
    80006b1c:	f456                	sd	s5,40(sp)
    80006b1e:	f05a                	sd	s6,32(sp)
    80006b20:	ec5e                	sd	s7,24(sp)
    80006b22:	e862                	sd	s8,16(sp)
    80006b24:	e466                	sd	s9,8(sp)
    80006b26:	e06a                	sd	s10,0(sp)
    80006b28:	1080                	addi	s0,sp,96
  int free = 0;

  for (int k = 0; k < MAXSIZE; k++) {   // skip max size
    80006b2a:	00021717          	auipc	a4,0x21
    80006b2e:	52e72703          	lw	a4,1326(a4) # 80028058 <nsizes>
    80006b32:	4785                	li	a5,1
    80006b34:	06e7df63          	bge	a5,a4,80006bb2 <bd_initfree+0xa4>
    80006b38:	8aaa                	mv	s5,a0
    80006b3a:	8b2e                	mv	s6,a1
    80006b3c:	4901                	li	s2,0
  int free = 0;
    80006b3e:	4a01                	li	s4,0
  int n = p - (char *) bd_base;
    80006b40:	00021c97          	auipc	s9,0x21
    80006b44:	508c8c93          	addi	s9,s9,1288 # 80028048 <bd_base>
  return n / BLK_SIZE(k);
    80006b48:	4c41                	li	s8,16
  for (int k = 0; k < MAXSIZE; k++) {   // skip max size
    80006b4a:	00021b97          	auipc	s7,0x21
    80006b4e:	50eb8b93          	addi	s7,s7,1294 # 80028058 <nsizes>
    80006b52:	a039                	j	80006b60 <bd_initfree+0x52>
    80006b54:	2905                	addiw	s2,s2,1
    80006b56:	000ba783          	lw	a5,0(s7)
    80006b5a:	37fd                	addiw	a5,a5,-1
    80006b5c:	04f95c63          	bge	s2,a5,80006bb4 <bd_initfree+0xa6>
    int left = blk_index_next(k, bd_left);
    80006b60:	85d6                	mv	a1,s5
    80006b62:	854a                	mv	a0,s2
    80006b64:	00000097          	auipc	ra,0x0
    80006b68:	dc4080e7          	jalr	-572(ra) # 80006928 <blk_index_next>
    80006b6c:	89aa                	mv	s3,a0
  int n = p - (char *) bd_base;
    80006b6e:	000cb483          	ld	s1,0(s9)
  return n / BLK_SIZE(k);
    80006b72:	409b04bb          	subw	s1,s6,s1
    80006b76:	012c17b3          	sll	a5,s8,s2
    80006b7a:	02f4c4b3          	div	s1,s1,a5
    80006b7e:	2481                	sext.w	s1,s1
    int right = blk_index(k, bd_right);
    free += bd_initfree_pair(k, left,bd_left,bd_right);
    80006b80:	86da                	mv	a3,s6
    80006b82:	8656                	mv	a2,s5
    80006b84:	85aa                	mv	a1,a0
    80006b86:	854a                	mv	a0,s2
    80006b88:	00000097          	auipc	ra,0x0
    80006b8c:	ede080e7          	jalr	-290(ra) # 80006a66 <bd_initfree_pair>
    80006b90:	01450d3b          	addw	s10,a0,s4
    80006b94:	000d0a1b          	sext.w	s4,s10
    if(right <= left)
    80006b98:	fa99dee3          	bge	s3,s1,80006b54 <bd_initfree+0x46>
      continue;
    free += bd_initfree_pair(k, right,bd_left,bd_right);
    80006b9c:	86da                	mv	a3,s6
    80006b9e:	8656                	mv	a2,s5
    80006ba0:	85a6                	mv	a1,s1
    80006ba2:	854a                	mv	a0,s2
    80006ba4:	00000097          	auipc	ra,0x0
    80006ba8:	ec2080e7          	jalr	-318(ra) # 80006a66 <bd_initfree_pair>
    80006bac:	00ad0a3b          	addw	s4,s10,a0
    80006bb0:	b755                	j	80006b54 <bd_initfree+0x46>
  int free = 0;
    80006bb2:	4a01                	li	s4,0
  }
  return free;
}
    80006bb4:	8552                	mv	a0,s4
    80006bb6:	60e6                	ld	ra,88(sp)
    80006bb8:	6446                	ld	s0,80(sp)
    80006bba:	64a6                	ld	s1,72(sp)
    80006bbc:	6906                	ld	s2,64(sp)
    80006bbe:	79e2                	ld	s3,56(sp)
    80006bc0:	7a42                	ld	s4,48(sp)
    80006bc2:	7aa2                	ld	s5,40(sp)
    80006bc4:	7b02                	ld	s6,32(sp)
    80006bc6:	6be2                	ld	s7,24(sp)
    80006bc8:	6c42                	ld	s8,16(sp)
    80006bca:	6ca2                	ld	s9,8(sp)
    80006bcc:	6d02                	ld	s10,0(sp)
    80006bce:	6125                	addi	sp,sp,96
    80006bd0:	8082                	ret

0000000080006bd2 <bd_mark_data_structures>:
...
bd_mark_data_structures(char *p) {
    ...
    80006bdc:	e44e                	sd	s3,8(sp)
    80006bde:	1800                	addi	s0,sp,48
    80006be0:	892a                	mv	s2,a0
  int meta = p - (char*)bd_base;
    80006be2:	00021997          	auipc	s3,0x21
    80006be6:	46698993          	addi	s3,s3,1126 # 80028048 <bd_base>
    80006bea:	0009b483          	ld	s1,0(s3)
    80006bee:	409504bb          	subw	s1,a0,s1
  printf("bd: %d meta bytes for managing %d bytes of memory\n", meta, BLK_SIZE(MAXSIZE));
    80006bf2:	00021797          	auipc	a5,0x21
    80006bf6:	4667a783          	lw	a5,1126(a5) # 80028058 <nsizes>
    80006bfa:	37fd                	addiw	a5,a5,-1
    80006bfc:	4641                	li	a2,16
    80006bfe:	00f61633          	sll	a2,a2,a5
    80006c02:	85a6                	mv	a1,s1
    80006c04:	00001517          	auipc	a0,0x1
    80006c08:	cfc50513          	addi	a0,a0,-772 # 80007900 <userret+0x870>
    80006c0c:	ffffa097          	auipc	ra,0xffffa
    80006c10:	986080e7          	jalr	-1658(ra) # 80000592 <printf>
  bd_mark(bd_base, p);
    80006c14:	85ca                	mv	a1,s2
    80006c16:	0009b503          	ld	a0,0(s3)
    80006c1a:	00000097          	auipc	ra,0x0
    80006c1e:	d5a080e7          	jalr	-678(ra) # 80006974 <bd_mark>
  return meta;
}
...
0000000080006c32 <bd_mark_unavailable>:

// Mark the range [end, HEAPSIZE) as allocated
int
bd_mark_unavailable(void *end, void *left) {
    80006c32:	1101                	addi	sp,sp,-32
    80006c34:	ec06                	sd	ra,24(sp)
    80006c36:	e822                	sd	s0,16(sp)
    80006c38:	e426                	sd	s1,8(sp)
    80006c3a:	1000                	addi	s0,sp,32
  int unavailable = BLK_SIZE(MAXSIZE)-(end-bd_base);
    80006c3c:	00021497          	auipc	s1,0x21
    80006c40:	41c4a483          	lw	s1,1052(s1) # 80028058 <nsizes>
    80006c44:	fff4879b          	addiw	a5,s1,-1
    80006c48:	44c1                	li	s1,16
    80006c4a:	00f494b3          	sll	s1,s1,a5
    80006c4e:	00021797          	auipc	a5,0x21
    80006c52:	3fa7b783          	ld	a5,1018(a5) # 80028048 <bd_base>
    80006c56:	8d1d                	sub	a0,a0,a5
    80006c58:	40a4853b          	subw	a0,s1,a0
    80006c5c:	0005049b          	sext.w	s1,a0
  if(unavailable > 0)
    80006c60:	00905a63          	blez	s1,80006c74 <bd_mark_unavailable+0x42>
    unavailable = ROUNDUP(unavailable, LEAF_SIZE);
    80006c64:	357d                	addiw	a0,a0,-1
    80006c66:	41f5549b          	sraiw	s1,a0,0x1f
    80006c6a:	01c4d49b          	srliw	s1,s1,0x1c
    80006c6e:	9ca9                	addw	s1,s1,a0
    80006c70:	98c1                	andi	s1,s1,-16
    80006c72:	24c1                	addiw	s1,s1,16
  printf("bd: 0x%x bytes unavailable\n", unavailable);
    80006c74:	85a6                	mv	a1,s1
    80006c76:	00001517          	auipc	a0,0x1
    80006c7a:	cc250513          	addi	a0,a0,-830 # 80007938 <userret+0x8a8>
    80006c7e:	ffffa097          	auipc	ra,0xffffa
    80006c82:	914080e7          	jalr	-1772(ra) # 80000592 <printf>

  void *bd_end = bd_base+BLK_SIZE(MAXSIZE)-unavailable;
    80006c86:	00021717          	auipc	a4,0x21
    80006c8a:	3c273703          	ld	a4,962(a4) # 80028048 <bd_base>
    80006c8e:	00021597          	auipc	a1,0x21
    80006c92:	3ca5a583          	lw	a1,970(a1) # 80028058 <nsizes>
    80006c96:	fff5879b          	addiw	a5,a1,-1
    80006c9a:	45c1                	li	a1,16
    80006c9c:	00f595b3          	sll	a1,a1,a5
    80006ca0:	40958533          	sub	a0,a1,s1
  bd_mark(bd_end, bd_base+BLK_SIZE(MAXSIZE));
    80006ca4:	95ba                	add	a1,a1,a4
    80006ca6:	953a                	add	a0,a0,a4
    80006ca8:	00000097          	auipc	ra,0x0
    80006cac:	ccc080e7          	jalr	-820(ra) # 80006974 <bd_mark>
  return unavailable;
}
    80006cb0:	8526                	mv	a0,s1
    80006cb2:	60e2                	ld	ra,24(sp)
    80006cb4:	6442                	ld	s0,16(sp)
    80006cb6:	64a2                	ld	s1,8(sp)
    80006cb8:	6105                	addi	sp,sp,32
    80006cba:	8082                	ret

0000000080006cbc <bd_init>:

// Initialize the buddy allocator: it manages memory from [base, end).
void
bd_init(void *base, void *end) {
    80006cbc:	715d                	addi	sp,sp,-80
    80006cbe:	e486                	sd	ra,72(sp)
    80006cc0:	e0a2                	sd	s0,64(sp)
    80006cc2:	fc26                	sd	s1,56(sp)
    80006cc4:	f84a                	sd	s2,48(sp)
    80006cc6:	f44e                	sd	s3,40(sp)
    80006cc8:	f052                	sd	s4,32(sp)
    80006cca:	ec56                	sd	s5,24(sp)
    80006ccc:	e85a                	sd	s6,16(sp)
    80006cce:	e45e                	sd	s7,8(sp)
    80006cd0:	e062                	sd	s8,0(sp)
    80006cd2:	0880                	addi	s0,sp,80
    80006cd4:	8c2e                	mv	s8,a1
  char *p = (char *) ROUNDUP((uint64)base, LEAF_SIZE);
    80006cd6:	fff50493          	addi	s1,a0,-1
    80006cda:	98c1                	andi	s1,s1,-16
    80006cdc:	04c1                	addi	s1,s1,16
  int sz;

  initlock(&lock, "buddy");
    80006cde:	00001597          	auipc	a1,0x1
    80006ce2:	c7a58593          	addi	a1,a1,-902 # 80007958 <userret+0x8c8>
    80006ce6:	00021517          	auipc	a0,0x21
    80006cea:	31a50513          	addi	a0,a0,794 # 80028000 <lock>
    80006cee:	ffffa097          	auipc	ra,0xffffa
    80006cf2:	bc0080e7          	jalr	-1088(ra) # 800008ae <initlock>
  bd_base = (void *) p;
    80006cf6:	00021797          	auipc	a5,0x21
    80006cfa:	3497b923          	sd	s1,850(a5) # 80028048 <bd_base>

  // compute the number of sizes we need to manage [base, end)
  nsizes = log2(((char *)end-p)/LEAF_SIZE) + 1;
    80006cfe:	409c0933          	sub	s2,s8,s1
    80006d02:	43f95513          	srai	a0,s2,0x3f
    80006d06:	893d                	andi	a0,a0,15
    80006d08:	954a                	add	a0,a0,s2
    80006d0a:	8511                	srai	a0,a0,0x4
    80006d0c:	00000097          	auipc	ra,0x0
    80006d10:	c46080e7          	jalr	-954(ra) # 80006952 <log2>
  if((char*)end-p > BLK_SIZE(MAXSIZE)) {
    80006d14:	47c1                	li	a5,16
    80006d16:	00a797b3          	sll	a5,a5,a0
    80006d1a:	1b27c663          	blt	a5,s2,80006ec6 <bd_init+0x20a>
  nsizes = log2(((char *)end-p)/LEAF_SIZE) + 1;
    80006d1e:	2505                	addiw	a0,a0,1
    80006d20:	00021797          	auipc	a5,0x21
    80006d24:	32a7ac23          	sw	a0,824(a5) # 80028058 <nsizes>
    nsizes++;  // round up to the next power of 2
  }

  printf("bd: memory sz is %d bytes; allocate an size array of length %d\n",
    80006d28:	00021997          	auipc	s3,0x21
    80006d2c:	33098993          	addi	s3,s3,816 # 80028058 <nsizes>
    80006d30:	0009a603          	lw	a2,0(s3)
    80006d34:	85ca                	mv	a1,s2
    80006d36:	00001517          	auipc	a0,0x1
    80006d3a:	c2a50513          	addi	a0,a0,-982 # 80007960 <userret+0x8d0>
    80006d3e:	ffffa097          	auipc	ra,0xffffa
    80006d42:	854080e7          	jalr	-1964(ra) # 80000592 <printf>
         (char*) end - p, nsizes);

  // allocate bd_sizes array
  bd_sizes = (Sz_info *) p;
    80006d46:	00021797          	auipc	a5,0x21
    80006d4a:	3097b523          	sd	s1,778(a5) # 80028050 <bd_sizes>
  p += sizeof(Sz_info) * nsizes;
    80006d4e:	0009a603          	lw	a2,0(s3)
    80006d52:	00561913          	slli	s2,a2,0x5
    80006d56:	9926                	add	s2,s2,s1
  memset(bd_sizes, 0, sizeof(Sz_info) * nsizes);
    80006d58:	0056161b          	slliw	a2,a2,0x5
    80006d5c:	4581                	li	a1,0
    80006d5e:	8526                	mv	a0,s1
    80006d60:	ffffa097          	auipc	ra,0xffffa
    80006d64:	d20080e7          	jalr	-736(ra) # 80000a80 <memset>

  // initialize free list and allocate the alloc array for each size k
  for (int k = 0; k < nsizes; k++) {
    80006d68:	0009a783          	lw	a5,0(s3)
    80006d6c:	06f05a63          	blez	a5,80006de0 <bd_init+0x124>
    80006d70:	4981                	li	s3,0
    lst_init(&bd_sizes[k].free);
    80006d72:	00021a97          	auipc	s5,0x21
    80006d76:	2dea8a93          	addi	s5,s5,734 # 80028050 <bd_sizes>
    sz = sizeof(char)* ROUNDUP(NBLK(k), 16)/16;
    80006d7a:	00021a17          	auipc	s4,0x21
    80006d7e:	2dea0a13          	addi	s4,s4,734 # 80028058 <nsizes>
    80006d82:	4b05                	li	s6,1
    lst_init(&bd_sizes[k].free);
    80006d84:	00599b93          	slli	s7,s3,0x5
    80006d88:	000ab503          	ld	a0,0(s5)
    80006d8c:	955e                	add	a0,a0,s7
    80006d8e:	00000097          	auipc	ra,0x0
    80006d92:	166080e7          	jalr	358(ra) # 80006ef4 <lst_init>
    sz = sizeof(char)* ROUNDUP(NBLK(k), 16)/16;
    80006d96:	000a2483          	lw	s1,0(s4)
    80006d9a:	34fd                	addiw	s1,s1,-1
    80006d9c:	413484bb          	subw	s1,s1,s3
    80006da0:	009b14bb          	sllw	s1,s6,s1
    80006da4:	fff4879b          	addiw	a5,s1,-1
    80006da8:	41f7d49b          	sraiw	s1,a5,0x1f
    80006dac:	01c4d49b          	srliw	s1,s1,0x1c
    80006db0:	9cbd                	addw	s1,s1,a5
    80006db2:	98c1                	andi	s1,s1,-16
    80006db4:	24c1                	addiw	s1,s1,16
    bd_sizes[k].alloc = p;
    80006db6:	000ab783          	ld	a5,0(s5)
    80006dba:	9bbe                	add	s7,s7,a5
    80006dbc:	012bb823          	sd	s2,16(s7)
    memset(bd_sizes[k].alloc, 0, sz);
    80006dc0:	8491                	srai	s1,s1,0x4
    80006dc2:	8626                	mv	a2,s1
    80006dc4:	4581                	li	a1,0
    80006dc6:	854a                	mv	a0,s2
    80006dc8:	ffffa097          	auipc	ra,0xffffa
    80006dcc:	cb8080e7          	jalr	-840(ra) # 80000a80 <memset>
    p += sz;
    80006dd0:	9926                	add	s2,s2,s1
  for (int k = 0; k < nsizes; k++) {
    80006dd2:	0985                	addi	s3,s3,1
    80006dd4:	000a2703          	lw	a4,0(s4)
    80006dd8:	0009879b          	sext.w	a5,s3
    80006ddc:	fae7c4e3          	blt	a5,a4,80006d84 <bd_init+0xc8>
  }

  // allocate the split array for each size k, except for k = 0, since
  // we will not split blocks of size k = 0, the smallest size.
  for (int k = 1; k < nsizes; k++) {
    80006de0:	00021797          	auipc	a5,0x21
    80006de4:	2787a783          	lw	a5,632(a5) # 80028058 <nsizes>
    80006de8:	4705                	li	a4,1
    80006dea:	06f75163          	bge	a4,a5,80006e4c <bd_init+0x190>
    80006dee:	02000a13          	li	s4,32
    80006df2:	4985                	li	s3,1
    sz = sizeof(char)* (ROUNDUP(NBLK(k), 8))/8;
    80006df4:	4b85                	li	s7,1
    bd_sizes[k].split = p;
    80006df6:	00021b17          	auipc	s6,0x21
    80006dfa:	25ab0b13          	addi	s6,s6,602 # 80028050 <bd_sizes>
  for (int k = 1; k < nsizes; k++) {
    80006dfe:	00021a97          	auipc	s5,0x21
    80006e02:	25aa8a93          	addi	s5,s5,602 # 80028058 <nsizes>
    sz = sizeof(char)* (ROUNDUP(NBLK(k), 8))/8;
    80006e06:	37fd                	addiw	a5,a5,-1
    80006e08:	413787bb          	subw	a5,a5,s3
    80006e0c:	00fb94bb          	sllw	s1,s7,a5
    80006e10:	fff4879b          	addiw	a5,s1,-1
    80006e14:	41f7d49b          	sraiw	s1,a5,0x1f
    80006e18:	01d4d49b          	srliw	s1,s1,0x1d
    80006e1c:	9cbd                	addw	s1,s1,a5
    80006e1e:	98e1                	andi	s1,s1,-8
    80006e20:	24a1                	addiw	s1,s1,8
    bd_sizes[k].split = p;
    80006e22:	000b3783          	ld	a5,0(s6)
    80006e26:	97d2                	add	a5,a5,s4
    80006e28:	0127bc23          	sd	s2,24(a5)
    memset(bd_sizes[k].split, 0, sz);
    80006e2c:	848d                	srai	s1,s1,0x3
    80006e2e:	8626                	mv	a2,s1
    80006e30:	4581                	li	a1,0
    80006e32:	854a                	mv	a0,s2
    80006e34:	ffffa097          	auipc	ra,0xffffa
    80006e38:	c4c080e7          	jalr	-948(ra) # 80000a80 <memset>
    p += sz;
    80006e3c:	9926                	add	s2,s2,s1
  for (int k = 1; k < nsizes; k++) {
    80006e3e:	2985                	addiw	s3,s3,1
    80006e40:	000aa783          	lw	a5,0(s5)
    80006e44:	020a0a13          	addi	s4,s4,32
    80006e48:	faf9cfe3          	blt	s3,a5,80006e06 <bd_init+0x14a>
  }
  p = (char *) ROUNDUP((uint64) p, LEAF_SIZE);
    80006e4c:	197d                	addi	s2,s2,-1
    80006e4e:	ff097913          	andi	s2,s2,-16
    80006e52:	0941                	addi	s2,s2,16
  ...
  int meta = bd_mark_data_structures(p);
    ...
    80006e5a:	d7c080e7          	jalr	-644(ra) # 80006bd2 <bd_mark_data_structures>
    80006e5e:	8a2a                	mv	s4,a0
  
  // mark the unavailable memory range [end, HEAP_SIZE) as allocated,
  // so that buddy will not hand out that memory.
  int unavailable = bd_mark_unavailable(end, p);
    80006e60:	85ca                	mv	a1,s2
    80006e62:	8562                	mv	a0,s8
    80006e64:	00000097          	auipc	ra,0x0
    80006e68:	dce080e7          	jalr	-562(ra) # 80006c32 <bd_mark_unavailable>
    80006e6c:	89aa                	mv	s3,a0
  void *bd_end = bd_base+BLK_SIZE(MAXSIZE)-unavailable;
    80006e6e:	00021a97          	auipc	s5,0x21
    80006e72:	1eaa8a93          	addi	s5,s5,490 # 80028058 <nsizes>
    80006e76:	000aa783          	lw	a5,0(s5)
    80006e7a:	37fd                	addiw	a5,a5,-1
    80006e7c:	44c1                	li	s1,16
    80006e7e:	00f497b3          	sll	a5,s1,a5
    80006e82:	8f89                	sub	a5,a5,a0
  
  // initialize free lists for each size k
  int free = bd_initfree(p, bd_end);
    80006e84:	00021597          	auipc	a1,0x21
    80006e88:	1c45b583          	ld	a1,452(a1) # 80028048 <bd_base>
    80006e8c:	95be                	add	a1,a1,a5
    80006e8e:	854a                	mv	a0,s2
    80006e90:	00000097          	auipc	ra,0x0
    80006e94:	c7e080e7          	jalr	-898(ra) # 80006b0e <bd_initfree>

  // check if the amount that is free is what we expect
  if(free != BLK_SIZE(MAXSIZE)-meta-unavailable) {
    80006e98:	000aa603          	lw	a2,0(s5)
    80006e9c:	367d                	addiw	a2,a2,-1
    80006e9e:	00c49633          	sll	a2,s1,a2
    80006ea2:	41460633          	sub	a2,a2,s4
    80006ea6:	41360633          	sub	a2,a2,s3
    80006eaa:	02c51463          	bne	a0,a2,80006ed2 <bd_init+0x216>
    printf("free %d %d\n", free, BLK_SIZE(MAXSIZE)-meta-unavailable);
    panic("bd_init: free mem");
  }
}
    80006eae:	60a6                	ld	ra,72(sp)
    80006eb0:	6406                	ld	s0,64(sp)
    80006eb2:	74e2                	ld	s1,56(sp)
    80006eb4:	7942                	ld	s2,48(sp)
    80006eb6:	79a2                	ld	s3,40(sp)
    80006eb8:	7a02                	ld	s4,32(sp)
    80006eba:	6ae2                	ld	s5,24(sp)
    80006ebc:	6b42                	ld	s6,16(sp)
    80006ebe:	6ba2                	ld	s7,8(sp)
    80006ec0:	6c02                	ld	s8,0(sp)
    80006ec2:	6161                	addi	sp,sp,80
    80006ec4:	8082                	ret
    nsizes++;  // round up to the next power of 2
    80006ec6:	2509                	addiw	a0,a0,2
    80006ec8:	00021797          	auipc	a5,0x21
    80006ecc:	18a7a823          	sw	a0,400(a5) # 80028058 <nsizes>
    80006ed0:	bda1                	j	80006d28 <bd_init+0x6c>
    printf("free %d %d\n", free, BLK_SIZE(MAXSIZE)-meta-unavailable);
    80006ed2:	85aa                	mv	a1,a0
    80006ed4:	00001517          	auipc	a0,0x1
    80006ed8:	acc50513          	addi	a0,a0,-1332 # 800079a0 <userret+0x910>
    80006edc:	ffff9097          	auipc	ra,0xffff9
    80006ee0:	6b6080e7          	jalr	1718(ra) # 80000592 <printf>
    panic("bd_init: free mem");
    80006ee4:	00001517          	auipc	a0,0x1
    80006ee8:	acc50513          	addi	a0,a0,-1332 # 800079b0 <userret+0x920>
    80006eec:	ffff9097          	auipc	ra,0xffff9
    80006ef0:	65c080e7          	jalr	1628(ra) # 80000548 <panic>

0000000080006ef4 <lst_init>:
...
lst_init(struct list *lst)
{
    ...
    80006ef6:	e422                	sd	s0,8(sp)
    80006ef8:	0800                	addi	s0,sp,16
  lst->next = lst;
    80006efa:	e108                	sd	a0,0(a0)
  lst->prev = lst;
    80006efc:	e508                	sd	a0,8(a0)
}
    80006efe:	6422                	ld	s0,8(sp)
    80006f00:	0141                	addi	sp,sp,16
    80006f02:	8082                	ret

0000000080006f04 <lst_empty>:

int
lst_empty(struct list *lst) {
    80006f04:	1141                	addi	sp,sp,-16
    80006f06:	e422                	sd	s0,8(sp)
    80006f08:	0800                	addi	s0,sp,16
  return lst->next == lst;
    80006f0a:	611c                	ld	a5,0(a0)
    80006f0c:	40a78533          	sub	a0,a5,a0
}
    80006f10:	00153513          	seqz	a0,a0
    80006f14:	6422                	ld	s0,8(sp)
    80006f16:	0141                	addi	sp,sp,16
    80006f18:	8082                	ret

0000000080006f1a <lst_remove>:

void
lst_remove(struct list *e) {
    80006f1a:	1141                	addi	sp,sp,-16
    80006f1c:	e422                	sd	s0,8(sp)
    80006f1e:	0800                	addi	s0,sp,16
  e->prev->next = e->next;
    80006f20:	6518                	ld	a4,8(a0)
    80006f22:	611c                	ld	a5,0(a0)
    80006f24:	e31c                	sd	a5,0(a4)
  e->next->prev = e->prev;
    80006f26:	6518                	ld	a4,8(a0)
    80006f28:	e798                	sd	a4,8(a5)
}
    80006f2a:	6422                	ld	s0,8(sp)
    80006f2c:	0141                	addi	sp,sp,16
    80006f2e:	8082                	ret

0000000080006f30 <lst_pop>:
...
lst_pop(struct list *lst) {
  ...
  if(lst->next == lst)
    80006f3a:	6104                	ld	s1,0(a0)
    80006f3c:	00a48d63          	beq	s1,a0,80006f56 <lst_pop+0x26>
    panic("lst_pop");
  struct list *p = lst->next;
  lst_remove(p);
    80006f40:	8526                	mv	a0,s1
    80006f42:	00000097          	auipc	ra,0x0
    80006f46:	fd8080e7          	jalr	-40(ra) # 80006f1a <lst_remove>
  return (void *)p;
}
    80006f4a:	8526                	mv	a0,s1
    80006f4c:	60e2                	ld	ra,24(sp)
    80006f4e:	6442                	ld	s0,16(sp)
    80006f50:	64a2                	ld	s1,8(sp)
    80006f52:	6105                	addi	sp,sp,32
    80006f54:	8082                	ret
    panic("lst_pop");
    80006f56:	00001517          	auipc	a0,0x1
    80006f5a:	a7250513          	addi	a0,a0,-1422 # 800079c8 <userret+0x938>
    80006f5e:	ffff9097          	auipc	ra,0xffff9
    80006f62:	5ea080e7          	jalr	1514(ra) # 80000548 <panic>

0000000080006f66 <lst_push>:
...
lst_push(struct list *lst, void *p)
{
  ...
  e->next = lst->next;
    80006f6c:	611c                	ld	a5,0(a0)
    80006f6e:	e19c                	sd	a5,0(a1)
  e->prev = lst;
    80006f70:	e588                	sd	a0,8(a1)
  lst->next->prev = p;
    80006f72:	611c                	ld	a5,0(a0)
    80006f74:	e78c                	sd	a1,8(a5)
  lst->next = e;
    80006f76:	e10c                	sd	a1,0(a0)
}
    80006f78:	6422                	ld	s0,8(sp)
    80006f7a:	0141                	addi	sp,sp,16
    80006f7c:	8082                	ret

0000000080006f7e <lst_print>:

void
lst_print(struct list *lst)
{
    80006f7e:	7179                	addi	sp,sp,-48
    80006f80:	f406                	sd	ra,40(sp)
    80006f82:	f022                	sd	s0,32(sp)
    80006f84:	ec26                	sd	s1,24(sp)
    80006f86:	e84a                	sd	s2,16(sp)
    80006f88:	e44e                	sd	s3,8(sp)
    80006f8a:	1800                	addi	s0,sp,48
  for (struct list *p = lst->next; p != lst; p = p->next) {
    80006f8c:	6104                	ld	s1,0(a0)
    80006f8e:	02950063          	beq	a0,s1,80006fae <lst_print+0x30>
    80006f92:	892a                	mv	s2,a0
    printf(" %p", p);
    80006f94:	00001997          	auipc	s3,0x1
    80006f98:	a3c98993          	addi	s3,s3,-1476 # 800079d0 <userret+0x940>
    80006f9c:	85a6                	mv	a1,s1
    80006f9e:	854e                	mv	a0,s3
    80006fa0:	ffff9097          	auipc	ra,0xffff9
    80006fa4:	5f2080e7          	jalr	1522(ra) # 80000592 <printf>
  for (struct list *p = lst->next; p != lst; p = p->next) {
    80006fa8:	6084                	ld	s1,0(s1)
    80006faa:	fe9919e3          	bne	s2,s1,80006f9c <lst_print+0x1e>
  }
  printf("\n");
    80006fae:	00000517          	auipc	a0,0x0
    80006fb2:	1f250513          	addi	a0,a0,498 # 800071a0 <userret+0x110>
    80006fb6:	ffff9097          	auipc	ra,0xffff9
    80006fba:	5dc080e7          	jalr	1500(ra) # 80000592 <printf>
}
